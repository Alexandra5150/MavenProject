...
public class TestDB {
	...
	public static void main (String[] args) {
		...
		String updateQuery = "update customers set CustomerName ='BlaBla' where CustomerName = 'Stan.G';";
		
		//System.out.println(DBQuerys.dbSelectQuery(conn, "select * from customers;"));
