...
public class CssSelectorExample extends BaseTest {
	...
	public void cssSelectorTest() {
		...
		//ul[id="menu_user"]--> cauta orice orice element UL care are id="menu_user"
		//# == [id=]
		...
		// . --> este o referinta catre atributul clasa
		...
		// spatiul (in loc de ">") sare peste parinti, se poate duce direct la nepoti, nu trb sa cobor
	...
	public void cssSelector2() {
		...
		//class="sc_title sc_title_regular sc_align_center margin_bottom_tiny"
		//CSS Wildcards
		//* -> contains
