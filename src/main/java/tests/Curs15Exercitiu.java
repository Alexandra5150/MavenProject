...
//		
//		jse.executeScript("document.getElementById('comment')[0].value='text text text'");
//		jse.executeScript("document.getElementById('author')[0].value='abcd'");
//		jse.executeScript("document.getElementById('email')[0].value='abcd@abcd.com'");
//		jse.executeScript("document.getElementById('send_comment')[0].click()");
